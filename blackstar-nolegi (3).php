                ...
                <form id="bsn-form-articolo">
                    ...
                    <!-- Campo ricerca articoli (sotto Salva, prima della lista) -->
                     <div class="bsn-list-toolbar" style="margin-top:10px;">
                        ...
                        <button type="button" class="btn btn-secondary" id="bsn-articoli-export-selected">Scarica CSV selezionati</button>
                        <button type="button" class="btn btn-secondary" id="bsn-articoli-export-filtered">Scarica CSV filtrati</button>
                    </div>
