...
function bsn_generate_noleggio_pdf( $noleggio_id, $force = false ) {
    ...
    if ( ! class_exists( 'Dompdf\\Dompdf' ) ) {
        require_once BSN_PATH . 'lib/dompdf/autoload.inc.php';
    }
...
function bsn_invia_email_noleggio_finalizzato( $noleggio, $cliente, $pdf_info ) {
    ...
    <div style="font-family: Arial, sans-serif; font-size:14px; color:#222;">
        ...
        Nota: tutte le spedizioni devono essere inviate al sopra citato indirizzo</p>
        ...
        E-mail: info@blackstarservice.com</p>
        <p>Sito web: https://www.blackstarservice.com/</p>
    ...
    if ( $cliente_email ) {
        wp_mail( $cliente_email, $subject, $body, $headers, $attachments );
    }

    wp_mail( 'noleggi@blackstarservice.it', $subject, $body, $headers, $attachments );
}
// [BSN_PDF_EMAIL_END]
