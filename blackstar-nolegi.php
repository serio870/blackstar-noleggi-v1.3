...
function bsn_render_public_product_availability_html( $product_id, $data_ritiro = '', $data_riconsegna = '', $args = [] ) {
    ...
    $html = '<div class="bsn-public-availability" style="margin:0 0 ' . ( $compact ? '0' : '16px' ) . '; padding:' . ( $compact ? '10px 12px' : '12px 14px' ) . '; border-radius:10px; background:' . esc_attr( $theme['bg'] ) . '; border:1px solid ' . esc_attr( $theme['border'] ) . ';">';
    if ( $title !== '' ) {
