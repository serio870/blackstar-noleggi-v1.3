...
while ( have_posts() ) :
    ...
    <main class="bsn-public-page bsn-prodotto-page">
        <div class="bsn-public-shell">
            ...
            <div class="bsn-price-label">Tariffa 1 giorno</div>
    <?php if ( null !== $price_standard ) : ?>
        <?php if ( null !== $price_reserved && $price_reserved < $price_standard ) : ?>
            <div class="bsn-price-main"><?php echo esc_html( number_format_i18n( $price_reserved, 2 ) ); ?> EUR<em>/ giorno</em></div>
            <div class="bsn-price-strikethrough">Tariffa standard: <?php echo esc_html( number_format_i18n( $price_standard, 2 ) ); ?> EUR</div>
        ...
        <?php else : ?>
            <div class="bsn-price-main"><?php echo esc_html( number_format_i18n( $price_standard, 2 ) ); ?> EUR<em>/ giorno</em></div>
